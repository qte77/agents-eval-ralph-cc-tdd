...
class EvaluationPipeline:
    ...
    def __init__(self, config: PipelineConfig) -> None:
        ...
        # Initialize evaluators for all three tiers
        self.traditional_calculator = MetricsCalculator()
    ...
    async def run(
        ...
        Args:
            agent_runs: List of agent run dictionaries for traditional metrics
        ...
        if agent_runs:
            metrics = self.traditional_calculator.calculate(agent_runs)
            traditional_metrics = {
